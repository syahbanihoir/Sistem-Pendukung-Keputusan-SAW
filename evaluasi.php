...
?>
                ...
                <form id="form" method="post" action="evaluasi.php" style="display: inline; padding-bottom: 10px;">
...
if ($kecamatan != '' || $tahun !='') {
  ...
  AND kecamatan LIKE '$kecamatan' AND tahun LIKE '$tahun'");
    ...
    $sql3  = mysqli_query($conn,"SELECT * FROM tbl_warga, tbl_matrik where tbl_matrik.nik=tbl_warga.nik");
...
while ($dt3 = mysqli_fetch_array($sql3))
 {
    ...
    // $C1 = (($dt3['kriteria1_jml_anggota_keluarga']/4)*$bobot[0]);
    // $C2 =((1/$dt3['kriteria2_pendidikan_kepala_keluarga'])*$bobot[1]);
    // $C3 =(($dt3['kriteria3_jml_anggotakeluarga_sekolah']/4)*$bobot[2]);
    // $C4 =(($dt3['kriteria4_pengeluaran_satu_jiwa']/4)*$bobot[3]);
    // $C5 =((1/$dt3['kriteria5_penghasilan_satu_jiwa'])*$bobot[4]);
    // $C6 = ((1/$dt3['kriteria6_status_rumah'])*$bobot[5]);
    // $C7 = ((1/$dt3['kriteria7_sumber_airbersih'])*$bobot[6]);
    // $C8 = ((1/$dt3['kriteria8_transportasi'])*$bobot[7]);
    
    $query1 = "UPDATE tbl_matrik SET total_nilai = $rangking WHERE tbl_matrik.nik = '$nik'";
    ...
    $status = $rangking;
        ...
        <td>".($dt3['nama'])."</td>
        <td align='center'>".round(($dt3['kriteria1_jml_anggota_keluarga']/$q['maxK1'])*$bobot[0],2)."</td>
        <td align='center'>".round($q['maxK2']/$dt3['kriteria2_pendidikan_kepala_keluarga']*$bobot[1],2)."</td>
        <td align='center'>".round(($dt3['kriteria3_jml_anggotakeluarga_sekolah']/$q['maxK3'])*$bobot[2],2)."</td>
        <td align='center'>".round(($dt3['kriteria4_pengeluaran_satu_jiwa']/$q['maxK4'])*$bobot[3],2)."</td>
        <td align='center'>".round($q['maxK5']/$dt3['kriteria5_penghasilan_satu_jiwa']*$bobot[4],2)."</td>
        <td align='center'>".round($q['maxK6']/$dt3['kriteria6_status_rumah']*$bobot[5],2)."</td>
        <td align='center'>".round($q['maxK7']/$dt3['kriteria7_sumber_airbersih']*$bobot[6],2)."</td>
        <td align='center'>".round($q['maxK8']/$dt3['kriteria8_transportasi']*$bobot[7],2)."</td>
