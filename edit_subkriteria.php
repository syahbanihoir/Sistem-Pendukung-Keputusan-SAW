        ...
        <article>
            <div class="card">
                <p style="font-size:18px; font-weight: bold; padding-left: 5px; margin-top: 10px; margin-bottom: 10px;">
                    Kriteria&nbsp;/
                    <a href="lihat_sub_kriteria.php">Lihat Sub-Kriteria</a>&nbsp;/&nbsp;Edit</a>
                </p>
            </div>
...
$query = "SELECT * FROM nilai_kriteria where idnilai_kriteria = $id_kriteria";
...
?>
                    ...
                    <form action="" method="post" class="card2">
                        ...
                        <tr class="box">
                            <td style="width: 350px;">
                                <label class="input-warga box-tengah" for="subkriteria">
                                    <p class="frominp">Nama Sub-Kriteria</p><span>:</span>
                                </label>
                            </td>
                            <td>
                                <input class="box-form-tengah" id="subkriteria" type="text" name="subkriteria"
                                    value="<?= $row['subkriteria'] ?>" />
                            </td>
                        </tr>

                        <tr class="box">
                            <td style="width: 350px;">
                                <label class="input-warga box-tengah" for="nilai">
                                    <p class="frominp">Nilai</p><span>:</span>
                                </label>
                            </td>
                            <td>
                                <input class="box-form-tengah" id="nilai" type="number" name="nilai"
                                    value="<?= $row['nilai'] ?>" />
                            </td>
                        </tr>
   ...
   if(isset($_POST['update'])) {
    ...
    $nilai = $_POST['nilai'];
		...
		$update1 = mysqli_query($conn,"UPDATE nilai_kriteria SET subkriteria='$subkriteria', nilai=$nilai WHERE idnilai_kriteria='$id_kriteria'") ;
      ...
      if ($update1) {
        echo "<script>
              swal('Sukses!', 'Data Berhasil Diubah', 'success').then(function() {
                  window.location.href = 'lihat_sub_kriteria.php'; //redirect ke halaman dashboard
              });
          </script>";
