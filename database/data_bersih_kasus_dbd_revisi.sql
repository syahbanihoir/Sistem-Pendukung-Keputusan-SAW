...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 30 Jun 2023 pada 11.51
...
(1, '317405xxxxxx0005', 3, 4, 3, 3, 4, 2, 1, 3, 0.88),
(2, '317405xxxxxx0003', 1, 4, 2, 3, 4, 4, 2, 3, 0.69),
(3, '317405xxxxxxx003', 3, 4, 2, 3, 4, 4, 3, 4, 0.66),
(4, '317405xxxxxx0001', 4, 4, 3, 3, 4, 4, 2, 3, 0.76),
(5, '317405xxxxxx0006', 3, 4, 3, 3, 4, 2, 2, 3, 0.8),
(6, '317405xxxxxx1001', 2, 3, 2, 3, 3, 2, 1, 3, 0.9),
(7, '317405xxxxxx0002', 2, 4, 2, 3, 3, 4, 2, 3, 0.75),
(8, '317405xxxxxx0008', 4, 4, 4, 3, 4, 2, 1, 3, 0.93),
(9, '317405xxxxxx1005', 3, 4, 3, 3, 4, 2, 1, 3, 0.88),
(10, '317405xxxxxx1002', 4, 4, 4, 3, 4, 3, 2, 3, 0.82),
(11, '317405xxxxxx008', 3, 4, 3, 3, 4, 4, 2, 4, 0.73);
...
('317405xxxxxx0005', 'Septian Ardiyansya', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxx0003', 'Rafi Syahrialdi Ramadhani', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxxx003', 'Faqih Alfarizi Azra ', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxx0001', 'Zulfarafida Syakira Nur', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxx0006', 'Fania Ambar Wanti ', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxx1001', 'Irma Widya', 'Kebayoran Lama', 'Kebayoran Lama Selatan', '2023'),
('317405xxxxxx0002', 'Shazia Nafeeza Al Mahyra', 'Kebayoran Lama', 'Cipulir', '2023'),
('317405xxxxxx0008', 'Ghazirah Answan', 'Kebayoran Lama', 'Cipulir', '2023'),
('317405xxxxxx1005', 'Farhan Sabarizi', 'Kebayoran Lama', 'Cipulir', '2023'),
('317405xxxxxx1002', 'Atthariq Jovian Salim', 'Kebayoran Lama', 'Cipulir', '2023'),
('317405xxxxxx008', 'Delillah ', 'Kebayoran Lama', 'Cipulir', '2023');
...
--
ALTER TABLE `tbl_matrik`
  MODIFY `id_matrik` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
